...
kd_full_deploy_labels = {
    Label('other',          0, 15,     (64, 64, 32),       u'其他'),
    Label('ignore',         1, 255,     (0, 0, 0),          u'Ignore'),
    ...
    Label('connection',     11, 11,   (128, 128, 192),    u'路面连接带'),
    Label('instructive',    28, 12,   (255, 0, 255),    u'路牌'),
    Label('pole',           37, 13,   (255, 140, 0),        u'杆'),
    Label('sky',            38, 14,   (135, 206, 235),    u'天空'),
}