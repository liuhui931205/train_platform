"""
Kuandeng Database(may be traffic signs, poles)
"""
...
class Kuandeng(IMDB):
    def __init__(self, image_set, root_path, dataset_path):
        ...
        :return: imdb object
        """
        super(Kuandeng, self).__init__('kuandeng', image_set, root_path, dataset_path)
        self.image_set = image_set
        self.root_path = root_path
        self.data_path = dataset_path

        #self.classes = ['__background__', 'warning', 'forbidden', 'instructive', 'highway', 'direction', 'other']
        #self.class_id = [0, 1, 2, 3, 4, 5, 6]
        self.classes = ['__background__', 'vehicles', 'pedestrian', 'traffic_signs', 'traffic_lights']
    ...
    def gt_roidb(self):
        ...
        if os.path.exists(cache_file):
            ...
            return roidb
        gt_roidb = self.load_annotations()
        ...
        for c in range(1, len(self.class_id)):
            ...
            for id in ids:
                ...
                if x_max - x_min <= 1 or y_max - y_min <= 1:
                    continue
                if (x_max - x_min) * (y_max - y_min) < 200:
                    continue
    ...
    def load_annotations(self):
        ...
        with open(imglist_file, 'r') as f:
            for line in f:
                ...
                file_list['ins_seg_path'] = label[1]
