...
class KuandengPole(IMDB):
    def __init__(self, image_set, root_path, dataset_path):
        ...
        :return: imdb object
        """
        super(KuandengPole, self).__init__('kuandeng', image_set, root_path, dataset_path)
        self.image_set = image_set
        self.root_path = root_path
        self.data_path = dataset_path

        self.classes = ['__background__', 'pole']
        self.class_id = [0, 1]

        # filter too small objects
        self.min_bbox_area = 500.0
